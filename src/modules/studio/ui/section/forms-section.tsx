...
import { CheckIcon, CopyIcon, Globe2Icon, ImagePlayIcon, Loader2Icon, LockIcon, MoreVerticalIcon, RefreshCwIcon, RotateCcwIcon, SparklesIcon, TrashIcon } from "lucide-react";
...
import { Column, ColumnBaseConfig, ColumnDataType, Assume, Table, TableConfig, SelectedFieldsFlat, View, ColumnsSelection } from "drizzle-orm";
...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const generateTitle = trpc.videos.generateTitle.useMutation({
        onSuccess: () => {
            toast.success("Background task for Title generation started successfully")
        },
        onError: () => {
    ...
    const generateDescription = trpc.videos.generateDescription.useMutation({
        onSuccess: () => {
            toast.success("Background task for description generation started successfully")
        },
        onError: () => {
