...
export const playlistRouter = createTRPCRouter({
  ...
  getVideosForPlaylist: protectedProcedure
    .input(
      z.object({
        cursor: z
          .object({
      ...
      const viewerVideoViews = db.$with("viewer_video_views").as(
        db
          .select({
            ...
            viewedAt: videoViews.updatedAt, // last viewed
          })
          .from(videoViews)
  ...
  // chcek in case this logic is invalid for gervideos maybe it might jsut fetch for history
