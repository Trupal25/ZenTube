...
import { VideoAssetCreatedWebhookEvent, VideoAssetDeletedWebhookEvent, VideoAssetErroredWebhookEvent, VideoAssetReadyWebhookEvent, VideoAssetTrackCreatedWebhookEvent, VideoAssetTrackReadyWebhookEvent, VideoUploadAssetCreatedWebhookEvent } from "@mux/mux-node/resources/webhooks.mjs";
...
export const POST = async (request: Request) => {
    ...
    switch (payload.type as WebhookEvent["type"]) {
        ...
        case "video.asset.ready": {
            ...
            const [uploadedThumbnail, uplodedPreview ] = await utapi.uploadFilesFromUrl([
                tempThumbnailUrl,
                tempPreviewUrl
            ]);
